...
public class prueba2 {//es la planilla para hacer el programa prueba
    ...
    public void test() {//clase de la anotacion test
        ...
        int noPersonas = jdbcTemplate.update("UPDATE persona SET nombre = ? ","pedro");//JDBCTemplate a través del patrón repositorio  y el código es  muy sencillo y se centra en la funcionalidad p/e aqui se centra en modificar el nombre de la persona.
