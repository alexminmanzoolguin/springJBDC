...
public class PruebaJDBC {//es la planilla para hacer el programa prueba
    ...
    public void test() {//clase de la anotacion test
        ...
        int noPersonas = jdbcTemplate.update("insert into persona(id_persona, nombre,ape_paterno,ape_materno,email) VALUES(?, ?, ?, ?)");//JDBCTemplate a través del patrón repositorio  y el código es  muy sencillo y se centra en la funcionalidad p/e aqui se centra en registrar a la persona.
