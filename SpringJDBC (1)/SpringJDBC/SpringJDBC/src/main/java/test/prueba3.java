...
public class PruebaJDBC {//es la planilla para hacer el programa prueba
    ...
    public void test() {//clase de la anotacion test
        ...
        int noPersonas = jdbcTemplate.update("DELETE FROM persona WHERE id_persona = ?",4);//JDBCTemplate a través del patrón repositorio  y el código es  muy sencillo y se centra en la funcionalidad p/e aqui se centra en consultar las personas.
